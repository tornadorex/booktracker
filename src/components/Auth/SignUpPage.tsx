  ...
  return (
    <div className="min-h-screen bg-[rgb(var(--bg-primary))] flex items-center justify-center p-4">
      ...
      <div className="bg-[rgb(var(--bg-secondary))] rounded-2xl shadow-[var(--shadow-lg)] w-full max-w-md p-8">
        ...
        <h1 className="text-3xl font-bold text-center text-[rgb(var(--text-primary))] mb-2">Create Account</h1>
        <p className="text-center text-[rgb(var(--text-tertiary))] mb-8">Start tracking your reading journey</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-sm font-medium text-[rgb(var(--text-secondary))] mb-2">
              Confirm Password
            </label>
            <input
              id="confirmPassword"
